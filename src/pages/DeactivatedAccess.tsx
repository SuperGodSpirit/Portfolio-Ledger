            ...
            <div className="max-w-md w-full bg-[#101418] border border-ledger-line rounded p-8 text-center space-y-6">
                ...
                <div>
                    ...
                    <p className="text-[#8793a3] text-sm">
                        Your account has been deactivated by an administrator. You no longer have access to the portfolio ledger.
                    </p>
                </div>
                ...
                <div className="pt-4 border-t border-ledger-line/50">
                    <a
                        ...
                        target="_blank"
                        rel="noreferrer"
                        className="w-full flex items-center justify-center px-4 py-3 bg-[#151a20] border border-ledger-line text-white font-semibold rounded hover:bg-[#1a2027] transition-colors"
                    >
...
export default DeactivatedAccess;
