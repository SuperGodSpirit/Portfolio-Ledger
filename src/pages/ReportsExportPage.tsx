      ...
      <div className="grid gap-6 lg:grid-cols-3">
        ...
        <div className="space-y-6">
          <div className="rounded-xl border border-white/5 bg-ledger-panel/80 p-6 backdrop-blur-md shadow-xl">
            ...
            <div className="rounded border border-ledger-amber/20 bg-ledger-amber/5 p-4 mb-6">
              <p className="text-[11px] leading-relaxed text-ledger-amber/90">
                <strong>Important:</strong> Reports generated by Portfolio Ledger are informational estimates based on user-provided data and should not be relied upon as official accounting, tax, legal, or regulatory records without independent verification.
              </p>
            </div>
